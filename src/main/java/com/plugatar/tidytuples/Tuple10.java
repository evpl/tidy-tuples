 ...
 */
public interface Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AnyTuple {
     ...
     */
    void supplyTo(Consumer<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6,
            ? super T7, ? super T8, ? super T9> consumer);
    ...
    <R> R applyTo(Function<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6,
            ? super T7, ? super T8, ? super T9, ? extends R> function);

    /**
     * Represents operation that accepts 10 items and returns no result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Consumer<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
         ...
         */
        void accept(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8, T9 i9);
    }

    /**
     * Represents function that accepts 10 items and produces a result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Function<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
         ...
         */
        R apply(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8, T9 i9);
    }
}
