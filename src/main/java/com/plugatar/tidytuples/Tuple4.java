 ...
 */
public interface Tuple4<T0, T1, T2, T3> extends AnyTuple {
     ...
     */
    void supplyTo(Consumer<? super T0, ? super T1, ? super T2, ? super T3> consumer);
     ...
     */
    <R> R applyTo(Function<? super T0, ? super T1, ? super T2, ? super T3, ? extends R> function);

    /**
     * Represents operation that accepts 4 items and returns no result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Consumer<T0, T1, T2, T3> {
         ...
         */
        void accept(T0 i0, T1 i1, T2 i2, T3 i3);
    }

    /**
     * Represents function that accepts 4 items and produces a result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Function<T0, T1, T2, T3, R> {
         ...
         */
        R apply(T0 i0, T1 i1, T2 i2, T3 i3);
    }
}
