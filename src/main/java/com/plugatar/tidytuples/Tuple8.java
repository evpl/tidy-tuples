...
public interface Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends AnyTuple {
    ...
    <R> R applyTo(Function<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6,
            ? super T7, ? extends R> function);

    /**
     * Represents operation that accepts 8 items and returns no result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Consumer<T0, T1, T2, T3, T4, T5, T6, T7> {
         ...
         */
        void accept(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7);
    }

    /**
     * Represents function that accepts 8 items and produces a result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Function<T0, T1, T2, T3, T4, T5, T6, T7, R> {
         ...
         */
        R apply(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7);
    }
}
