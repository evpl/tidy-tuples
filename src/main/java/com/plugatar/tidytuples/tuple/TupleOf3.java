 ...
 */
public final class TupleOf3<T0, T1, T2> extends AbstractTuple<Object> implements Tuple3<T0, T1, T2> {
    private final T0 i0;
    private final T1 i1;
    private final T2 i2;
     ...
     */
    public TupleOf3(final T0 i0, final T1 i1, final T2 i2) {
        super(new Object[]{i0, i1, i2});
        this.i0 = i0;
        this.i1 = i1;
        this.i2 = i2;
    }
