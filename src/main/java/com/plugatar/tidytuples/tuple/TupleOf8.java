 ...
 */
public final class TupleOf8<T0, T1, T2, T3, T4, T5, T6, T7> extends AbstractTuple<Object>
     ...
     */
    public TupleOf8(final T0 i0, final T1 i1, final T2 i2, final T3 i3, final T4 i4, final T5 i5, final T6 i6,
                    final T7 i7) {
        super(new Object[]{i0, i1, i2, i3, i4, i5, i6, i7});
        this.i0 = i0;
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
