 ...
 */
public interface Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> extends AnyTuple {
    ...
    <R> R applyTo(Function<? super T0, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6,
            ? super T7, ? super T8, ? extends R> function);

    /**
     * Represents operation that accepts 9 items and returns no result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Consumer<T0, T1, T2, T3, T4, T5, T6, T7, T8> {
         ...
         */
        void accept(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8);
    }

    /**
     * Represents function that accepts 9 items and produces a result.
     *
     * @param <T0> the type of the 0th item
     * @param <T1> the type of the 1st item
     * @param <T2> the type of the 2nd item
     ...
     */
    @FunctionalInterface
    interface Function<T0, T1, T2, T3, T4, T5, T6, T7, T8, R> {
         ...
         */
        R apply(T0 i0, T1 i1, T2 i2, T3 i3, T4 i4, T5 i5, T6 i6, T7 i7, T8 i8);
    }
}
